...
SECRET_KEY = '#$4xj0z9&g(*(hnrvam55w!u3*7(09w8o@=+=&e#ny28hhx%y&'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework.authentication.SessionAuthentication', ), 'PAGE_SIZE': 10,
    ...
    'DEFAULT_RENDERER_CLASSES': ('rest_framework_json_api.renderers.JSONRenderer',
                                 'rest_framework.renderers.BrowsableAPIRenderer', ), 'DEFAULT_METADATA_CLASS':
